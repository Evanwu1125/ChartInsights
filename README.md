...
- Accuracy Calculation
    With the [Model_Response file](/Model_Response_Template.json), in this format, run [Accuracy Calculation](/Accuracy_Calculation/_main_.py). Finally,  you can get [6 csv file](/Accuracy_Table/) containing details about test result.
