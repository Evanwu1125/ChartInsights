...
def analysis():
    ...
    for key, correct_count in counters_chart_answer.items():
        ...
        if total_count > 0:
            ...
            charts_rate[key] = 0  # 如果没有这种类型的题目，正确率设置为0
    ...
    for key, correct_count in counters_question_answer.items():
        ...
        if total_count > 0:
            ...
            questions_rate[key] = 0  # 如果没有这种类型的题目，正确率设置为0
    ...
    for key, correct_count in counters_chart2question_answer.items():
        ...
        if total_count > 0:
            ...
            chart2question_rate[key] = 0  # 如果没有这种类型的题目，正确率设置为0
